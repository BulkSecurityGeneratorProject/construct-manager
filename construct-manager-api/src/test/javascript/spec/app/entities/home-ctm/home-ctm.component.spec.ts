...
import { HomeCtmComponent } from 'app/entities/home-ctm/home-ctm.component';
import { HomeCtmService } from 'app/entities/home-ctm/home-ctm.service';
import { HomeCtm } from 'app/shared/model/home-ctm.model';

describe('Component Tests', () => {
    describe('HomeCtm Management Component', () => {
        let comp: HomeCtmComponent;
        let fixture: ComponentFixture<HomeCtmComponent>;
        let service: HomeCtmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ConstructManagerApiTestModule],
                declarations: [HomeCtmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(HomeCtmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(HomeCtmComponent);
