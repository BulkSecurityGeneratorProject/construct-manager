...
import { ProductCtmComponent } from 'app/entities/product-ctm/product-ctm.component';
...
describe('Component Tests', () => {
    describe('ProductCtm Management Component', () => {
        let comp: ProductCtmComponent;
        let fixture: ComponentFixture<ProductCtmComponent>;
        let service: ProductCtmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ConstructManagerApiTestModule],
                declarations: [ProductCtmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ProductCtmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ProductCtmComponent);
