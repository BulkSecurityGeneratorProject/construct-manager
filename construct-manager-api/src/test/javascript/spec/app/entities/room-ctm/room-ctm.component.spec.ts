...
import { RoomCtmComponent } from 'app/entities/room-ctm/room-ctm.component';
import { RoomCtmService } from 'app/entities/room-ctm/room-ctm.service';
import { RoomCtm } from 'app/shared/model/room-ctm.model';

describe('Component Tests', () => {
    describe('RoomCtm Management Component', () => {
        let comp: RoomCtmComponent;
        let fixture: ComponentFixture<RoomCtmComponent>;
        let service: RoomCtmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ConstructManagerApiTestModule],
                declarations: [RoomCtmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(RoomCtmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(RoomCtmComponent);
