...
import { ShopCtmComponent } from 'app/entities/shop-ctm/shop-ctm.component';
import { ShopCtmService } from 'app/entities/shop-ctm/shop-ctm.service';
import { ShopCtm } from 'app/shared/model/shop-ctm.model';

describe('Component Tests', () => {
    describe('ShopCtm Management Component', () => {
        let comp: ShopCtmComponent;
        let fixture: ComponentFixture<ShopCtmComponent>;
        let service: ShopCtmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ConstructManagerApiTestModule],
                declarations: [ShopCtmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ShopCtmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ShopCtmComponent);
