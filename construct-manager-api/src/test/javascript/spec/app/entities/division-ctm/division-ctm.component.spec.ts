...
import { DivisionCtmComponent } from 'app/entities/division-ctm/division-ctm.component';
...
describe('Component Tests', () => {
    describe('DivisionCtm Management Component', () => {
        let comp: DivisionCtmComponent;
        let fixture: ComponentFixture<DivisionCtmComponent>;
        let service: DivisionCtmService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ConstructManagerApiTestModule],
                declarations: [DivisionCtmComponent],
                providers: [
                    {
                ...
                .overrideTemplate(DivisionCtmComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(DivisionCtmComponent);
