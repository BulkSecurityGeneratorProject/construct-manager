...
import fr.mathieugeissler.constructmanager.domain.Product;
import fr.mathieugeissler.constructmanager.repository.ProductRepository;
import fr.mathieugeissler.constructmanager.service.ProductService;
import fr.mathieugeissler.constructmanager.service.dto.ProductDTO;
import fr.mathieugeissler.constructmanager.service.mapper.ProductMapper;
...
public class ProductResourceIntTest {
    ...
    private static final Double DEFAULT_PACKAGING = 1D;
    private static final Double UPDATED_PACKAGING = 2D;

    private static final Unit DEFAULT_PACKAGING_UNIT = Unit.ML;
    private static final Unit UPDATED_PACKAGING_UNIT = Unit.KG;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .packagingUnit(DEFAULT_PACKAGING_UNIT)
            .link(DEFAULT_LINK)
            .price(DEFAULT_PRICE)
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPackagingUnit()).isEqualTo(DEFAULT_PACKAGING_UNIT);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].packaging").value(hasItem(DEFAULT_PACKAGING.doubleValue())))
            .andExpect(jsonPath("$.[*].packagingUnit").value(hasItem(DEFAULT_PACKAGING_UNIT.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.packaging").value(DEFAULT_PACKAGING.doubleValue()))
            .andExpect(jsonPath("$.packagingUnit").value(DEFAULT_PACKAGING_UNIT.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .packagingUnit(UPDATED_PACKAGING_UNIT)
            .link(UPDATED_LINK)
            .price(UPDATED_PRICE)
        ...
        assertThat(testProduct.getPackagingUnit()).isEqualTo(UPDATED_PACKAGING_UNIT);
